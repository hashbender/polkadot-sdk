...
pub enum ProspectiveParachainsMessage {
	...
	/// Get the known output heads for a given parachain.
	///
	/// Returns a `HashSet` of output heads that are seconded.
	GetKnownOutputHeads(ParaId, oneshot::Sender<HashSet<Hash>>),
}
